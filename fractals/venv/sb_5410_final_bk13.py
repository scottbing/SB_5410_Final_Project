...
class Application(Frame):
    ...
    def rectSierpinski(self):
        ...
        a = self.iterations.get()
        Sierpinski(a1, b1, c1, k1, iteration=self.iterations.get())
        # plt.hold(True)
        Sierpinski(a1u, b1u, c1u, k1u, iteration=self.iterations.get())
        # plt.hold(True)
        Sierpinski(a2, b2, c2, k2, iteration=self.iterations.get())
        # plt.hold(True)
        Sierpinski(a2r, b2r, c2r, k2r, iteration=self.iterations.get())
        # plt.hold(True)

        plt.title("A Cubistic Sierpinski Synthesis (iterations = self.iterations.get())")
        ax.set_xlim(0, 1)
        ax.set_ylim(0, 1)
        plt.axis('equal')
        plt.axis('off')
