...
class Application(Frame):
    ...
    def symcoloredsierpinski(self):
        ...
        plt.title("Asymmetrical (cut at 1/5) Randomly Colored Sierpinski Triangle (iterations = " + str(iterations) + ")")
        plt.axis('equal')
        plt.axis('off')
        plt.show()
    ...
    def rectSierpinski(self):
        ...
        Sierpinski(a1, b1, c1, k1, iteration=self.itercube.get())
        # plt.hold(True)
        Sierpinski(a1u, b1u, c1u, k1u, iteration=self.itercube.get())
        # plt.hold(True)
        Sierpinski(a2, b2, c2, k2, iteration=self.itercube.get())
        # plt.hold(True)
        Sierpinski(a2r, b2r, c2r, k2r, iteration=self.itercube.get())
        # plt.hold(True)
