...
def main(iterations, axiom, rules, angle, length=None, size=None, correction_angle=0,
         ...
         flip_v=False, width=None, height=None, margin=None, aspect_ratio=None, c1="red", c2="green", c3="blue"):
...
main(iterations, axiom, rules, angle, aspect_ratio=1, width=width, c1="red", c2="green", c3="blue")